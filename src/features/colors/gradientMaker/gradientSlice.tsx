...
const GradientSlice = createSlice({
  ...
  reducers: {
    ...
    setType: (state, action: PayloadAction<initialGradientStateType["type"]>) => {
      state.type = action.payload
    },
    setKind: (state, action: PayloadAction<initialGradientStateType["kind"]>) => {
    ...
    setNewStops: (state, action: PayloadAction<initialGradientStateType>) => {
