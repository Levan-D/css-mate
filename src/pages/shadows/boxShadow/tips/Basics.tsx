...
const Basics = () => {
  return (
    <section id="Basics">
      ...
      <p>
        Box shadows are a powerful design tool that can add depth and dimension
        to any website or application. Whether you're creating a subtle drop
        shadow or a more dramatic effect, the ability to control the position,
        size, and color of a shadow can help you create visually appealing
        layouts and user interfaces. In this article, we will explore the
        various ways in which you can use box shadows to enhance your designs,
        including tips and tricks for creating custom effects.
      </p>
      ...
      <div className="mx-auto my-12 w-fit rounded-xl border-2 border-slate-600 bg-slate-700 px-8 py-6 shadow-[0px_0px_20px_0px_rgba(94,_161,_255,0.8)]">
        <p>
          ...
          <span className="text-green-300">
            inset <span className="text-secondary-300">(boolean)</span> ,
            offset-x
        ...
        <div className=" mt-2 hidden md:flex">
          ...
          <div className="w-fit translate-x-[370px]">
            ...
            <p className=" translate-x-8 rotate-[5deg] font-cursiveCustom text-sm font-bold">
              optional
            </p>
          </div>
          <div>
            <ArrowIcon
              ...
              width={26}
              stroke="#ff725e"
              className={`w-fit translate-x-[390px] rotate-[30deg] scale-x-[-1]`}
            />
          </div>
        </div>
      </div>
      ...
      <ol className="mx-auto max-w-xl">
        <li className="mb-4 list-decimal font-bold">
          ...
          <span className="font-normal ">
            This value is optional, and it makes the shadow inside the element
            rather than outside.
          </span>
        </li>
        <li className="mb-4 list-decimal font-bold">
        ...
        <li className="mb-4 list-decimal font-bold">
          Spread radius:&#32;
          <span className="font-normal ">
            This value sets the size of the shadow. A positive value will
            increase the size of the shadow, while a negative value will
            decrease it.
          </span>
        </li>
        <li className="mb-4 list-decimal font-bold">
