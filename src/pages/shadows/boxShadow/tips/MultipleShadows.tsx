...
const MultipleShadows = () => {
  return (
    <section id="Multiple shadows">
      ...
      <div className="mx-auto mt-8 mb-16 w-fit rounded-xl bg-slate-200 px-8 py-5 text-slate-900   shadow-[inset_-8px_-8px_8px_0px_rgba(0,0,0,0.25),0px_0px_0px_2px_rgba(100,100,100,1),8px_12px_4px_0px_rgba(255,255,_255,0.30)] ">
        <blockquote>
          <q>
