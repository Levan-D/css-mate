    ...
    <div>
      ...
      <section>
        ...
        <div className="flex justify-center gap-8 ">
          <div className="bg-transparent text-white px-12 py-16 rounded-xl w-fit shadow-[inset_-5px_-5px_16px_-10px_rgba(255,_255,_255,0.6),inset_5px_5px_16px_2px_rgba(0,_0,_0,1),inset_12px_12px_4px_150px_rgba(0,_0,_0,0.05)] ">
            <blockquote>
              <q className="    text-lg  ">
          ...
          <div className="bg-white  text-black px-12 py-16 rounded-full  w-[200px] h-[200px] shadow-[0px_0px_0px_1px_rgba(0,_0,_0,1),inset_-15px_-15px_50px_5px_rgba(0,_0,_0,0.86),inset_-35px_-45px_80px_50px_rgba(94,_161,_255,1),20px_20px_20px_0px_rgba(0,_0,_0,1)] ">
            <blockquote>
      ...
      <section>
        ...
        <div className="flex justify-center gap-8 ">
          ...
          <div className="bg-red-500 rotate-[4deg] z-30 translate-x-[-40px] translate-y-[-60px] mt-20 text-white px-12 py-16 rounded-md w-[300px]  shadow-[0px_0px_0px_30px_rgba(230,230,230,1),0px_30px_0px_30px_rgba(230,230,230,1),-10px_60px_30px_5px_rgba(0,_0,_0,1),35px_60px_30px_0px_rgba(0,_0,_0,1),35px_-10px_30px_0px_rgba(0,_0,_0,1)] ">
            <blockquote>
              <q className="    text-lg    ">
